  ...
  <body id="body">
    ...
    <br><br>
      ...
      <div class="card text-center" style="width: 80rem;">
        ...
        <div class="card-body">
      <br>
      <h2 id="titulo">SECTOR <i class="fas fa-user-alt"></i></h2>
      <center>
      <table class="table" style="width: 60rem;">
        <thead class="thead-dark">
          <?php
              ...
              $sql=("SELECT sector.idsector, sector.sector, sec_eco.sectoreconomico
                     FROM sector
                      INNER JOIN sec_eco ON sector.SEC_ECO_idsececo = sec_eco.idsececo");
              ...
              $query=mysqli_query($mysqli,$sql);
                  ...
                  echo "<th scope='col'>ID SECTOR </th>";
                 ...
                 while($arreglo=mysqli_fetch_array($query)){
                   echo "<tr class='bg-primary'>";
                    echo "<tbody class='table-secondary'>";
                      ...
                      echo "<td><center><a href='actualizarsector.php?id=$arreglo[0]'><i class='fas fa-user-edit'></i></center></i></center></td>";
                      echo "<td><center><a href='borrarsec.php?id=$arreglo[0]&idborrar=2'><i class='far fa-trash-alt'></i></center></a></td>";
                  echo "</tr>";
                }
              ?>
            </center>
