    ...
    <div class="card text-center" style="width: 80rem;">
      <div class="card-header">
        Ingrese el sector
         ...
         <form class="text-center border border-light p-5" action="registrarsector.php" method="post">

             <p class="h4 mb-4">Registrar sector </p>


             <!-- sector -->
             <label>Descripción sector</label>
             <div class="form-group">
                 <textarea class="form-control rounded-0"  rows="3" placeholder="Describe el sector" name="sector"></textarea>
             </div>
             <br>
