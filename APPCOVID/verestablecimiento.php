...
<html lang="en" dir="ltr">
  <head>
    <meta charset="utf-8">
    <title>Ver establecimiento</title>
  ...
  <body id="body">
    ...
    <br><br>
      ...
      <div class="card text-center" style="width: 80rem;">
        ...
        <div class="card-body">
      <br>
      <h2 id="titulo">ESTABLECIMIENTO <i class="fas fa-user-alt"></i></h2>
      <center>
      <table class="table" style="width: 60rem;">
        <thead class="thead-dark">
          <?php
              ...
              $sql=("SELECT est.idest,est.establecimiento,sector.sector
                      FROM sector
                      INNER JOIN est ON sector.idsector = est.SECTOR_idsector");
              ...
              $query=mysqli_query($mysqli,$sql);
                  ...
                  echo "<th scope='col'>ID ESTABLECIMIENTO</th>";
                 ...
                 while($arreglo=mysqli_fetch_array($query)){
                   echo "<tr class='bg-primary'>";
                    echo "<tbody class='table-secondary'>";
                      ...
                      echo "<td><center><a href='actualizarest.php?id=$arreglo[0]'><i class='fas fa-user-edit'></i></center></i></center></td>";
                      echo "<td><center><a href='borrarest.php?id=$arreglo[0]&idborrar=2'><i class='far fa-trash-alt'></i></center></a></td>";
                  echo "</tr>";
                }
              ?>
            </center>
