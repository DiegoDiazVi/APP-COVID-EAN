...
<html lang="en" dir="ltr">
  ...
  <body id="body">
    ...
    <img src="imagen/logo3.png" width="130" height="130">
      ...
      <br>
      <center>
      <div class="card text-center" style="width: 110rem;">
                 ...
                 while($arreglo=mysqli_fetch_array($query)){
                   echo "<tr class='bg-primary'>";
                    echo "<tbody class='table-secondary'>";
                      ...
                      echo "<td><center><a href='actualizarcuenta.php?id=$arreglo[0]'><i class='fas fa-user-edit'></i></center></i></center></td>";
                      echo "<td><center><a href='borrarcuenta.php?id=$arreglo[0]&idborrar=2'><i class='far fa-trash-alt'></i></center></a></td>";
                  echo "</tr>";
                }
              ?>
            </center>
