...
<html lang="en" dir="ltr">
  <head>
    <meta charset="utf-8">
    <title>Registrar Sector económico</title>
  ...
  <body id="body">
    ...
    <div class="card text-center" style="width: 80rem;">
      <div class="card-header">
        Ingrese el sector económico
      </div>
                <!-- Default form contact -->
         <form class="text-center border border-light p-5" action="registrasectoreconomico.php" method="post">

             <p class="h4 mb-4">Registrar sector económico</p>


             <!-- sector -->
             <label>Descripción sector económico</label>
             <div class="form-group">
                 <textarea class="form-control rounded-0"  rows="3" placeholder="Describe el sector" name="sectoreconomico"></textarea>
             </div>
             <br>
    ...
    <div class="card-footer text-muted" >
      ...
      © 2020 App covidl Related Services Company, Inc.
    </div>
